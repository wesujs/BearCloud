...
const Navbar = () => {
  ...
  return (
    <div className='w-screen h-[80px] z-10 bg-[transparent] fixed drop-shadow-lg md:backdrop-blur-sm '>
      ...
      <ul className={!nav ? 'hidden' : 'absolute bg-zinc-200 w-full px-8'}>
        ...
        <div className='flex flex-col my-4'>
            <button className='bg-transparent text-violet-700 px-8 py-3 mb-4'>Sign In</button>
            <button className='px-8 py-3'>Sign Up</button>
        </div>
      </ul>
    </div>
